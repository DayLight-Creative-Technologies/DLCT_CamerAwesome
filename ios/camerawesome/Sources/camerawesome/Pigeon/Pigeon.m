...
+ (instancetype)makeWithIsManualExposureSupported:(BOOL )isManualExposureSupported
    ...
    minShutterSpeed:(double )minShutterSpeed
    maxShutterSpeed:(double )maxShutterSpeed
    currentISO:(double )currentISO
    currentShutterSpeed:(double )currentShutterSpeed {
  ExposureCapabilities* pigeonResult = [[ExposureCapabilities alloc] init];
  pigeonResult.isManualExposureSupported = isManualExposureSupported;
  pigeonResult.minISO = minISO;
  pigeonResult.maxISO = maxISO;
  pigeonResult.minShutterSpeed = minShutterSpeed;
  pigeonResult.maxShutterSpeed = maxShutterSpeed;
  pigeonResult.currentISO = currentISO;
  pigeonResult.currentShutterSpeed = currentShutterSpeed;
  return pigeonResult;
}
+ (ExposureCapabilities *)fromList:(NSArray<id> *)list {
  ExposureCapabilities *pigeonResult = [[ExposureCapabilities alloc] init];
  pigeonResult.isManualExposureSupported = [GetNullableObjectAtIndex(list, 0) boolValue];
  pigeonResult.minISO = [GetNullableObjectAtIndex(list, 1) doubleValue];
  pigeonResult.maxISO = [GetNullableObjectAtIndex(list, 2) doubleValue];
  pigeonResult.minShutterSpeed = [GetNullableObjectAtIndex(list, 3) doubleValue];
  pigeonResult.maxShutterSpeed = [GetNullableObjectAtIndex(list, 4) doubleValue];
  pigeonResult.currentISO = [GetNullableObjectAtIndex(list, 5) doubleValue];
  pigeonResult.currentShutterSpeed = [GetNullableObjectAtIndex(list, 6) doubleValue];
  return pigeonResult;
}
+ (nullable ExposureCapabilities *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [ExposureCapabilities fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.isManualExposureSupported),
    @(self.minISO),
    @(self.maxISO),
    @(self.minShutterSpeed),
    @(self.maxShutterSpeed),
    @(self.currentISO),
    @(self.currentShutterSpeed),
  ];
}
@end
...
void SetUpCameraInterfaceWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<CameraInterface> *api, NSString *messageChannelSuffix) {
  ...
  /// Full exposure capabilities in a single round-trip.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.getExposureCapabilities", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getExposureCapabilitiesWithError:)], @"CameraInterface api (%@) doesn't respond to @selector(getExposureCapabilitiesWithError:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        ExposureCapabilities *output = [api getExposureCapabilitiesWithError:&error];
        callback(wrapResult(output, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  /// ISO priority mode. Pass -1 to return to auto.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.setManualISO", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setManualISOIso:completion:)], @"CameraInterface api (%@) doesn't respond to @selector(setManualISOIso:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        double arg_iso = [GetNullableObjectAtIndex(args, 0) doubleValue];
        [api setManualISOIso:arg_iso completion:^(FlutterError *_Nullable error) {
          callback(wrapResult(nil, error));
        }];
      }];
    } else {
  ...
  /// Shutter priority mode. Duration in seconds. Pass -1 to return to auto.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.setManualShutterSpeed", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setManualShutterSpeedDurationInSeconds:completion:)], @"CameraInterface api (%@) doesn't respond to @selector(setManualShutterSpeedDurationInSeconds:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        double arg_durationInSeconds = [GetNullableObjectAtIndex(args, 0) doubleValue];
        [api setManualShutterSpeedDurationInSeconds:arg_durationInSeconds completion:^(FlutterError *_Nullable error) {
          callback(wrapResult(nil, error));
        }];
      }];
    } else {
  ...
  /// Full manual mode. Pass -1 for either param to keep it auto.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.setManualExposure", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setManualExposureIso:durationInSeconds:completion:)], @"CameraInterface api (%@) doesn't respond to @selector(setManualExposureIso:durationInSeconds:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        double arg_iso = [GetNullableObjectAtIndex(args, 0) doubleValue];
        double arg_durationInSeconds = [GetNullableObjectAtIndex(args, 1) doubleValue];
        [api setManualExposureIso:arg_iso durationInSeconds:arg_durationInSeconds completion:^(FlutterError *_Nullable error) {
          callback(wrapResult(nil, error));
        }];
      }];
    } else {
  ...
  /// Return to fully automatic exposure.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.setAutoExposure", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setAutoExposureWithCompletion:)], @"CameraInterface api (%@) doesn't respond to @selector(setAutoExposureWithCompletion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        [api setAutoExposureWithCompletion:^(FlutterError *_Nullable error) {
          callback(wrapResult(nil, error));
        }];
      }];
    } else {
  ...
  /// iOS: rate parameter (1.0+, higher = faster). Android: animation duration in ms.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camerawesome.CameraInterface.setSmoothZoom", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:nullGetPigeonCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setSmoothZoomZoom:rateOrDuration:completion:)], @"CameraInterface api (%@) doesn't respond to @selector(setSmoothZoomZoom:rateOrDuration:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        double arg_zoom = [GetNullableObjectAtIndex(args, 0) doubleValue];
        double arg_rateOrDuration = [GetNullableObjectAtIndex(args, 1) doubleValue];
        [api setSmoothZoomZoom:arg_zoom rateOrDuration:arg_rateOrDuration completion:^(FlutterError *_Nullable error) {
          callback(wrapResult(nil, error));
        }];
      }];
    } else {
