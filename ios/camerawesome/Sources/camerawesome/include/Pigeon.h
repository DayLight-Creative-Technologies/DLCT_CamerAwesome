...
@property(nonatomic, assign) double  minISO;
@property(nonatomic, assign) double  maxISO;
@property(nonatomic, assign) double  minShutterSpeed;
@property(nonatomic, assign) double  maxShutterSpeed;
@property(nonatomic, assign) double  currentISO;
@property(nonatomic, assign) double  currentShutterSpeed;
@end
...
///
/// @return `nil` only when `error != nil`.
- (nullable ExposureCapabilities *)getExposureCapabilitiesWithError:(FlutterError *_Nullable *_Nonnull)error;
