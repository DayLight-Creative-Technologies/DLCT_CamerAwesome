...
data class ExposureCapabilities (
  ...
  val minISO: Double,
  val maxISO: Double,
  val minShutterSpeed: Double,
  val maxShutterSpeed: Double,
  val currentISO: Double,
  val currentShutterSpeed: Double
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): ExposureCapabilities {
      val isManualExposureSupported = pigeonVar_list[0] as Boolean
      val minISO = pigeonVar_list[1] as Double
      val maxISO = pigeonVar_list[2] as Double
      val minShutterSpeed = pigeonVar_list[3] as Double
      val maxShutterSpeed = pigeonVar_list[4] as Double
      val currentISO = pigeonVar_list[5] as Double
      val currentShutterSpeed = pigeonVar_list[6] as Double
      return ExposureCapabilities(isManualExposureSupported, minISO, maxISO, minShutterSpeed, maxShutterSpeed, currentISO, currentShutterSpeed)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
      isManualExposureSupported,
      minISO,
      maxISO,
      minShutterSpeed,
      maxShutterSpeed,
...
interface CameraInterface {
  ...
  fun setManualISO(iso: Double, callback: (Result<Unit>) -> Unit)
  /** Shutter priority mode. Duration in seconds. Pass -1 to return to auto. */
  fun setManualShutterSpeed(durationInSeconds: Double, callback: (Result<Unit>) -> Unit)
  /** Full manual mode. Pass -1 for either param to keep it auto. */
  fun setManualExposure(iso: Double, durationInSeconds: Double, callback: (Result<Unit>) -> Unit)
  /** Return to fully automatic exposure. */
  fun setAutoExposure(callback: (Result<Unit>) -> Unit)
  /**
   * Native-ramped zoom. [zoom] normalized 0.0-1.0.
   * iOS: rate parameter (1.0+, higher = faster). Android: animation duration in ms.
   */
  fun setSmoothZoom(zoom: Double, rateOrDuration: Double, callback: (Result<Unit>) -> Unit)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: CameraInterface?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.CameraInterface.getExposureCapabilities$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              listOf(api.getExposureCapabilities())
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.CameraInterface.setManualISO$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val isoArg = args[0] as Double
            api.setManualISO(isoArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.CameraInterface.setManualShutterSpeed$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val durationInSecondsArg = args[0] as Double
            api.setManualShutterSpeed(durationInSecondsArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.CameraInterface.setManualExposure$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val isoArg = args[0] as Double
            val durationInSecondsArg = args[1] as Double
            api.setManualExposure(isoArg, durationInSecondsArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.CameraInterface.setAutoExposure$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.setAutoExposure{ result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.camerawesome.CameraInterface.setSmoothZoom$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val zoomArg = args[0] as Double
            val rateOrDurationArg = args[1] as Double
            api.setSmoothZoom(zoomArg, rateOrDurationArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
